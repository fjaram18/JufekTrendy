        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" class="form-group" action="{{ route('admin.product.save') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input required type="number" class="form-control" placeholder="100" name="price" value="{{ old('price') }}" />
                        </div>
                        <div class="mb-3">
